...
rsync -ratlz --rsh="/usr/bin/sshpass -p Sourceforge*8180 ssh -o StrictHostKeyChecking=no -l xyen8180" [BETA-CN]"$ZIPNAME"_by_XYEN.7z xyen8180@frs.sourceforge.net:/home/frs/project/xyen-roms/star

...
echo " ===+++ Uploading Zip +++==="
rsync -ratlz --rsh="/usr/bin/sshpass -p wLU09QlgSMZhICV ssh -o StrictHostKeyChecking=no -l dargons10" [BETA-CN]"$ZIPNAME"_by_XD.z01 dargons10@frs.sourceforge.net:/home/pfs/project/xdroms/star
